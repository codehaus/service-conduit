...
public class OrderComponentITest extends TestCase {
    ...
    @Reference protected JpaOrderComponent jpaOrderComponent;
    ...
    public void testOrder() throws SQLException {
        ...
        String orderId = jpaOrderComponent.placeOrder("Pizza", "ABC", "DEF");
        assertEquals("Pizza", jpaOrderComponent.getOrder(orderId));
