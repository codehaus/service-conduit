...
public class RequestScopeInterceptorBuilder implements InterceptorBuilder<RequestScopeInterceptorDefinition, RequestScopeInterceptor> {
    ...
    public RequestScopeInterceptor build(RequestScopeInterceptorDefinition definition) throws BuilderException {
        return new RequestScopeInterceptor((RequestScopeContainer) scopeRegistry.getScopeContainer(Scope.REQUEST));
    }
