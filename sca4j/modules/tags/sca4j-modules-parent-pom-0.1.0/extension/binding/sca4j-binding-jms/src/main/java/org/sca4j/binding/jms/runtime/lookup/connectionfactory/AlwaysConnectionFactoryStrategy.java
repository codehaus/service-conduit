 ...
 * 
 * @version $Revision: 4186 $ $Date: 2008-05-13 04:19:40 +0100 (Tue, 13 May 2008) $
 *
 */
public class AlwaysConnectionFactoryStrategy implements ConnectionFactoryStrategy {

    /**
     * @see org.sca4j.binding.jms.runtime.lookup.connectionfactory.ConnectionFactoryStrategy#getConnectionFactory(org.sca4j.binding.jms.common.ConnectionFactoryDefinition, java.util.Hashtable)
     */
