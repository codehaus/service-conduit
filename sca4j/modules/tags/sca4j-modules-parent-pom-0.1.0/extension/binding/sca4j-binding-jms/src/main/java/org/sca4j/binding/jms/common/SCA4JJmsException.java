 ...
 * 
 * @version $Revision: 3140 $ $Date: 2008-03-17 21:24:49 +0000 (Mon, 17 Mar 2008) $
 */
public class SCA4JJmsException extends RuntimeException {
     ...
     */
    public SCA4JJmsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message Message for the exception.
     */
    public SCA4JJmsException(String message) {
        super(message);
    }
