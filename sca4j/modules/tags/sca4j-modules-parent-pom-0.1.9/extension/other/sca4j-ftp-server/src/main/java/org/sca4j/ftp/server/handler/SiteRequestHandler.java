...
/**
 * Handles the <code>QUOTE</code> command.
 * <p/>
 *
 * @version $Revision$ $Date$
 */
public class SiteRequestHandler implements RequestHandler {
    ...
    public void service(Request request) {
        ...
        session.addSiteCommand(request.getArgument());
        session.write(new DefaultResponse(200, "SITE command successful"));
