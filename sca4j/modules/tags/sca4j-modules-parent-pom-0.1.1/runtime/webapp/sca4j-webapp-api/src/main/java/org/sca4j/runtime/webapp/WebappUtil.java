...
public interface WebappUtil {
    ...
    ScdlBootstrapper getBootstrapper(ClassLoader bootClassLoader) throws SCA4JInitException;

    RuntimeLifecycleCoordinator<WebappRuntime, Bootstrapper> getCoordinator(ClassLoader bootClassLoader) throws SCA4JInitException;
