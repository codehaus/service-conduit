...
public class ReplyLoader implements TypeLoader<ReplyDefinition> {
    ...
    @Override
    public ReplyDefinition load(XMLStreamReader reader, IntrospectionContext context) throws XMLStreamException {
        ...
        return new ReplyDefinition(operation, partnerLink, variable);
    }
