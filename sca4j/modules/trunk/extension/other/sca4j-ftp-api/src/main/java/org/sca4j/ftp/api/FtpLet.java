...
public interface FtpLet {
     ...
     */
    boolean onUpload(String fileName, Session ftpSession, InputStream uploadData) throws Exception;

    /**
     * Callback for retrieving downloaded data 
     * 
     * @param fileName Name of the file being downloaded
     * @param ftpSession FTP session.
     */
    InputStream onDownload(String fileName, Session ftpSession) throws Exception;
