...
public class AmbiguousAutowireTargets extends AssemblyFailure {
     ...
     */
    public AmbiguousAutowireTargets(LogicalReference logicalReference, List<URI> candidates) {
    ...
    public String getMessage() {
        return "The autowired single reference " + logicalReference.getUri() + 
               " has more than one targets " + candidates;
    }
}
