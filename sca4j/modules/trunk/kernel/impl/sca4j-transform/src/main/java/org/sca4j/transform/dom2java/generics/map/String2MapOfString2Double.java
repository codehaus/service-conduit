 ...
 */
public class String2MapOfString2Double extends AbstractPullTransformer<Node, Map<String, Double>> {
    
    private static Map<String, Double> FIELD = null;
    private static JavaParameterizedType TARGET = null;
    
    static {
        try {
            ParameterizedType parameterizedType = (ParameterizedType) String2MapOfString2Double.class.getDeclaredField("FIELD").getGenericType();
     ...
     */
    public Map<String, Double> transform(final Node node, final TransformContext context)
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if (child instanceof Element) {
                ...
                map.put(element.getTagName(), Double.valueOf(child.getTextContent()));
            }
        }
        return map;
    }
