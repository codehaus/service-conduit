 ...
 */
public class String2ListOfDouble extends AbstractPullTransformer<Node, List<Double>> {

    private static List<Double> FIELD = null;
    private static JavaParameterizedType TARGET = null;

    static {
        try {
            ParameterizedType parameterizedType = (ParameterizedType) String2ListOfDouble.class.getDeclaredField("FIELD").getGenericType();
    ...
    public List<Double> transform(final Node node, final TransformContext context) throws TransformationException {
