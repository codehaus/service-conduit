 ...
 */
public class String2ListOfInt extends AbstractPullTransformer<Node, List<Integer>> {

    private static List<Integer> FIELD = null;
    private static JavaParameterizedType TARGET = null;

    static {
        try {
            ParameterizedType parameterizedType = (ParameterizedType) String2ListOfInt.class.getDeclaredField("FIELD").getGenericType();
    ...
    public List<Integer> transform(final Node node, final TransformContext context) throws TransformationException {
