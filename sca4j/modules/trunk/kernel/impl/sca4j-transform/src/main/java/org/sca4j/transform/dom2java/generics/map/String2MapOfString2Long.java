 ...
 */
public class String2MapOfString2Long extends AbstractPullTransformer<Node, Map<String, Long>> {
    
    private static Map<String, Long> FIELD = null;
    private static JavaParameterizedType TARGET = null;
    
    static {
        try {
            ParameterizedType parameterizedType = (ParameterizedType) String2MapOfString2Long.class.getDeclaredField("FIELD").getGenericType();
     ...
     */
    public Map<String, Long> transform(final Node node, final TransformContext context)
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if (child instanceof Element) {
                ...
                map.put(element.getTagName(), Long.valueOf(child.getTextContent()));
            }
        }
        return map;
    }
