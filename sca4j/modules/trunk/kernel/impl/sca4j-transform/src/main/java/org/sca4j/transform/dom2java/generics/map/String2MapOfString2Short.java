 ...
 */
public class String2MapOfString2Short extends AbstractPullTransformer<Node, Map<String, Short>> {
    
    private static Map<String, Short> FIELD = null;
    private static JavaParameterizedType TARGET = null;
    
    static {
        try {
            ParameterizedType parameterizedType = (ParameterizedType) String2MapOfString2Short.class.getDeclaredField("FIELD").getGenericType();
     ...
     */
    public Map<String, Short> transform(final Node node, final TransformContext context)
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if (child instanceof Element) {
                ...
                map.put(element.getTagName(), Short.valueOf(child.getTextContent()));
            }
        }
        return map;
    }
