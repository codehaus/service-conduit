 ...
 */
public class String2MapOfString2Float extends AbstractPullTransformer<Node, Map<String, Float>> {
    
    private static Map<String, Float> FIELD = null;
    private static JavaParameterizedType TARGET = null;
    
    static {
        try {
            ParameterizedType parameterizedType = (ParameterizedType) String2MapOfString2Float.class.getDeclaredField("FIELD").getGenericType();
     ...
     */
    public Map<String, Float> transform(final Node node, final TransformContext context)
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if (child instanceof Element) {
                ...
                map.put(element.getTagName(), Float.valueOf(child.getTextContent()));
            }
        }
        return map;
    }
